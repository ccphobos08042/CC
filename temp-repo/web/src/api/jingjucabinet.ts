...
enum URL{
    list='/myapp/admin/jingjucabinet/list',
    create = '/myapp/admin/jingjucabinet/create',
    update = '/myapp/admin/jingjucabinet/update',
    delete = '/myapp/admin/jingjucabinet/delete',
}
