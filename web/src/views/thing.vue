        ...
        <div style="padding-right: 16px; max-height:480px; overflow-x: hidden;overflow-y: auto;">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="选择课程" name="classification">
                  <a-select placeholder="请选择"
                            allowClear
                            mode="multiple"
                            :options="modal.courseData"
                            :field-names="{ label: 'course_name', value: 'course_name',}"
                            v-model:value="modal.courseinfoarr">
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
...
const handleEdit = (record: any) => {
  ...
  modal.courseinfoarr = record['courseinfo'].split(',')
};
  ...
  myform.value
      ...
      .then(() => {
        ...
        if (modal.editFlag) {
          ...
          modal.form.courseinfo = modal.courseinfoarr.join(",")
          updateApi({
            id: modal.form.id
          }, modal.form)
              .then((res) => {
